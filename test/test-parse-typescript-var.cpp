...
TEST_F(test_parse_typescript_var, let_can_have_type_annotation) {
...

  {
    ...
    EXPECT_THAT(p.visits, ElementsAre("visit_variable_type_use",       // C
                                      ...
                                      "visit_variable_declaration"));  // x
    EXPECT_THAT(p.variable_uses, ElementsAre(u8"C", u8"init"));
  }

  {
    ...
    EXPECT_THAT(p.variable_uses, ElementsAre(u8"init", u8"Array"));
  }

  {
    ...
    EXPECT_THAT(p.variable_uses, ElementsAre(u8"T", u8"y"));
  }
}
