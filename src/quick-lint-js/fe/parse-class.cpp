  ...
  struct class_parser {
    ...
    void error_if_access_specifier_not_first_in_field() {
      if (p->options_.typescript && !modifiers.empty()) {
        check_if_access_specifier_precedes_given_modifiers(span<const token_type>({
    ...
    void check_if_access_specifier_precedes_given_modifiers(span<const token_type> tokens) {
