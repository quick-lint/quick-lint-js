...
void parser::visit_expression(expression* ast, parse_visitor_base& v,
  ...
  case expression_kind::assignment: {
    ...
    if (both_sides_are_variables) {
      string8_view lhs_variable_name = lhs_without_paren->variable_identifier().normalized_name();
      string8_view rhs_variable_name = rhs_without_paren->variable_identifier().normalized_name();
