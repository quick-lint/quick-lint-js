...
constexpr std::uint16_t translation_table_mapping_table_size = 299;
constexpr std::size_t translation_table_string_table_size = 59549;
...
QLJS_CONSTEVAL std::uint16_t translation_table_const_hash_table_look_up(
  ...
  constexpr const_hash_entry const_hash_table[] = {
          ...
          {298, "~~~ invalid string, do not use outside benchmark ~~~"},
          {0, ""},
          {0, ""},
          {0, ""},
          {0, ""},
          ...
          {297, "{1:headlinese} value must be a compile-time constant"},
  ...
  std::uint64_t hash = hash_fnv_1a_64(untranslated, 14695981039346657843ULL);
  std::uint64_t table_size = 448;
