...
//
// #define QLJS_ERROR_TYPE(error_name, error_code, severity, struct_body,
// format) ...
//
...
#define QLJS_ERROR_TYPE(name, code, severity, struct_body, format_call) name,
  QLJS_X_ERROR_TYPES
#undef QLJS_ERROR_TYPE
};
...
#define QLJS_ERROR_TYPE(name, code, severity, struct_body, format_call) +1
    QLJS_X_ERROR_TYPES
#undef QLJS_ERROR_TYPE
    ;
}
