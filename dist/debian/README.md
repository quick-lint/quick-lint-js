...
`dist/debian/quick-lint-js_0.7.0-1_amd64.deb`,
`dist/debian/quick-lint-js-vim_0.7.0-1_all.deb`, and related files.
...
instructions), install the .deb file:
    ...
    $ sudo dpkg -i dist/debian/quick-lint-js_0.7.0-1_amd64.deb
    $ sudo dpkg -i dist/debian/quick-lint-js-vim_0.7.0-1_all.deb
