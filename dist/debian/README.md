...
6. Copy `dist/debian/*2.6.0*` (built by the [Building](#Building) instructions
...
2. Create a package using `package.sh`:
   `./dist/debian/package.sh --output-directory debian-package --orig path/to/quick-lint-js-2.6.0.tar.gz --sign`
