...
func main() {
	...
	sourceTarballPath := filepath.Join(destinationDir, "source/quick-lint-js-2.0.0.tar.gz")
	log.Printf("signing with GPG: %s\n", sourceTarballPath)
...
var filesToTransform map[string]map[string]FileTransformType = map[string]map[string]FileTransformType{
	...
	"npm/quick-lint-js-2.0.0.tgz": map[string]FileTransformType{
	...
	"vscode/quick-lint-js-2.0.0.vsix": map[string]FileTransformType{
